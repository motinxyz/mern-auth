...
describe("DatabaseConnectionManager", () => {
    ...
    describe("Constructor", () => {
        it("should throw ConfigurationError if config is missing", () => {
            expect(() => new DatabaseConnectionManager({ logger: mockLogger })).toThrow();
        });
        it("should throw ConfigurationError if logger is missing", () => {
            expect(() => new DatabaseConnectionManager({ config: mockConfig })).toThrow();
        });
    ...
    describe("connect", () => {
        it("should connect successfully on first attempt", async () => {
            ...
            expect(mockConnect).toHaveBeenCalledWith(mockConfig.dbURI, expect.objectContaining({
    ...
    describe("ping", () => {
        it("should throw if not connected", async () => {
            ...
            vi.spyOn(mongoose.default.connection, "readyState", "get").mockReturnValue(0);
