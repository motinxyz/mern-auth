...
import { TooManyRequestsError, ConflictError, } from "@auth/utils";
// Mock utils
...
describe("Registration Service", () => {
    ...
    describe("registerUser", () => {
        it("should register a new user and orchestrate verification", async () => {
            ...
            registrationService.tokenService.createVerificationToken.mockResolvedValue("test_token");
            ...
            expect(registrationService.tokenService.createVerificationToken).toHaveBeenCalledWith(expect.objectContaining({
                ...userData,
                _id: "123",
            }));
        ...
        it("should throw TooManyRequestsError if rate limit is exceeded", async () => {
            ...
            await expect(registrationService.register(userData)).rejects.toThrow(TooManyRequestsError);
        });
        it("should throw ConflictError if email already exists", async () => {
            ...
            mockRedisConnection.get.mockResolvedValue(null);
            await expect(registrationService.register(userData)).rejects.toThrow(ConflictError);
        });
        it("should handle failure when adding job to queue", async () => {
            ...
            await expect(registrationService.register(userData)).rejects.toThrow(ServiceUnavailableError);
        });
...
//# sourceMappingURL=registration.service.test.js.map