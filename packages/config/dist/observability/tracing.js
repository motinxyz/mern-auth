...
export function initializeTracing() {
    ...
    try {
        const { serviceName, serviceVersion, environment, tempo } = observabilityConfig.tracing;
        ...
        log.info({ authConfigured: Object.keys(tempo.headers).length > 0 }, "Auth headers status");
                ...
                getNodeAutoInstrumentations({
                    ...
                    "@opentelemetry/instrumentation-http": {
                        ...
                        requestHook: (span, request) => {
                            ...
                            span.setAttribute("http.host", request.headers?.host || "unknown");
                        },
                    ...
                    "@opentelemetry/instrumentation-express": {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        spanNameHook: (info, _defaultName) => {
                    ...
                    ["@opentelemetry/instrumentation-redis-4"]: {
                        enabled: true,
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        responseHook: (span, cmdName, _cmdArgs, _response) => {
