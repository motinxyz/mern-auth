...
class MailerSendProvider {
    ...
    fromEmail;
    logger;
    constructor({ apiKey, webhookSecret, fromEmail, logger }) {
    ...
    async send(mailOptions) {
        ...
        try {
            ...
            this.logger.error({ err: error, body: error.body }, "MailerSend send failed");
            throw error;
        }
    }
...
//# sourceMappingURL=mailersend.provider.js.map