...
class DatabaseConnectionError extends ApiError {
    ...
    constructor(originalError) {
        super(HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR, "system:db.connectionFailedAfterRetries", originalError ? [{ message: originalError.message, stack: originalError.stack }] : []);
    }
}
