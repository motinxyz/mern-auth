...
const defaultLocalePath = path.join(__dirname, "../locales/en/system.json");
...
try {
  ...
  // Wrap the content in a 'system' namespace to match the structure of the async loader.
  translations = { system: JSON.parse(fileContent) };
} catch (error) {
